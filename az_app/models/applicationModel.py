...
# class DocumentAddedProgress(db_con.Model):
#
#     id_doc_prg = Column(Integer, primary_key=True, autoincrement=True)
#     id_fk_added_doc = Column(Integer, ForeignKey(DocumentAdded.id_doc, ondelete='CASCADE'), nullable=False)
#     progress = Column(Integer, nullable=False)
#     extracted_page = Column(Integer, nullable=False)
#     date_extract = Column(DateTime, default=datetime.date(datetime.utcnow()))
#
#     def __int__(self, id_fk_added_doc, progress, extracted_page, date_extract):
#
#         self.id_fk_added_doc = id_fk_added_doc
